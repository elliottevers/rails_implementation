This is my implementation of an MVC framework that behaves a lot like Rails.  You
...
trivial with knowledge of the APIs of the following libraries: Rack,
active_support/inflector, Regexp, and ERB.  To experiment with it, run
'ruby server.rb' and use the following API I have set up to interact with the
database via the browser:
